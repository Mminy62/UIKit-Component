...
struct Friends {
    ...
    var nameDescription: String {
        get {
            return "\(name), \(message?.count ?? 0) 글자 작성"
        }
    }
}
...
struct FriendsInfo {
    let list: [Friends] = [
        Friends(
            name: "김민준",
            message: "오늘도 행복하세요 ☺️오늘도 행복하세요 ☺️오늘도 행복하세요 ☺️오늘도 행복하세요 ☺️ 오늘도 행복하세요 ☺️오늘도 행복하세요 ☺️ 오늘도 행복하세요 ☺️오늘도 행복하세요 ☺️ 오늘도 행복하세요 ☺️오늘도 행복하세요 ☺️ 오늘도 행복하세요 ☺️오늘도 행복하세요 ☺️ 오늘도 행복하세요 ☺️오늘도 행복하세요 ☺️ 오늘도 행복하세요 ☺️오늘도 행복하세요 ☺️ 오늘도 행복하세요 ☺️오늘도 행복하세요 ☺️",
        ...
        Friends(
            name: "최예린",
            message: "인생은 단 한 번뿐이니까 인생은 단 한 번뿐이니까인생은 단 한 번뿐이니까인생은 단 한 번뿐이니까",
            profile_image: nil,
            phone: 45678901,
            like: true
        ),
